  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedIndex){
      ...
      case 1:
        ...
        break;
      default:
        throw UnimplementedError("Nenhuma pagina selecionada para $selectedIndex");
    }
        ...
        children: [
          SafeArea(
              child: NavigationRail(
                extended: false,
                destinations: [
                  NavigationRailDestination(icon: Icon(Icons.home), label: Text("Principal")),
  ...
  Widget build(BuildContext context){
    ...
    return ListView(
      children: [
        Padding(
          padding: const EdgeInsets.all(20),
          child: Text("Voce possui ${appState.favorites.length} favoritos"),
        ),
